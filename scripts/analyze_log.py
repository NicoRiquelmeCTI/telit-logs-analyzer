...
def format_report(stats: dict) -> str:
    ...
    report.append(f"\nSINR Statistics:")
    report.append(f"Mean: {stats['signal_quality']['sinr']['mean']:.2f} ratio")
    report.append(f"Std Dev: {stats['signal_quality']['sinr']['std']:.2f} ratio")
    report.append(f"Min: {stats['signal_quality']['sinr']['min']} ratio")
    report.append(f"Max: {stats['signal_quality']['sinr']['max']} ratio")
    report.append(f"Median: {stats['signal_quality']['sinr']['median']} ratio")
